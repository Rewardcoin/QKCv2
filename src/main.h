...
inline bool IsProtocolV1RetargetingFixed(int nHeight) { return TestNet() || nHeight > 500; }
inline bool IsProtocolV2(int nHeight) { return TestNet() || nHeight > 1000; }
inline bool IsProtocolV3(int64_t nTime) { return TestNet() || nTime > 1456113600; }
